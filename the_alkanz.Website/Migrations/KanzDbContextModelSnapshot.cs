...
namespace the_alkanz.Website.Migrations
{
    ...
    partial class KanzDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("the_alkanz.Website.Models.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("the_alkanz.Website.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("the_alkanz.Website.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("the_alkanz.Website.Models.OrderItem", b =>
                {
                    b.HasOne("the_alkanz.Website.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("the_alkanz.Website.Models.Product", b =>
                {
                    b.HasOne("the_alkanz.Website.Models.Category", "Category")
                        .WithMany("Products")
